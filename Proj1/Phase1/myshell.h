...
/* 
 * myshell.c - Functions for the CS:APP3e book
 *
 * Updated 8/2014 droh: 
...
{
    return write(STDOUT_FILENO, s, sio_strlen(s)); //line:myshell:siostrlen
}
...
ssize_t sio_putl(long v) /* Put long */
{
    ...
    sio_ltoa(v, s, 10); /* Based on K&R itoa() */  //line:myshell:sioltoa
    return sio_puts(s);
}
...
int open_listenfd(char *port) 
{
    ...
    for (p = listp; p; p = p->ai_next) {
        ...
        Setsockopt(listenfd, SOL_SOCKET, SO_REUSEADDR,    //line:netp:myshell:setsockopt
